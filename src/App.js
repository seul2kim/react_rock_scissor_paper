...
function App() {
  ...
  return(
    //컴포넌트는 반드시 하나를 return 해야하니까 하나로 감싸야지 에러가 발생하지 않는다.
    <div>
  <div className='main'>
